...
void wave(int Nx, int Ny, int Nt) {
    ...
    for (int T = 0; T < Nt; ++T) {
        ...
        for (int i = 1; i < Ny - 1; ++i) {
            register int j;
            for (j = 1; j <= Nx - 5; j += 4) {
                __m256d cur = _mm256_loadu_pd(tmpCur);
                _mm256_storeu_pd(tmpPrev,
                                 _mm256_add_pd(_mm256_sub_pd(_mm256_add_pd(cur, cur), _mm256_loadu_pd(tmpPrev)),
                                               _mm256_fmadd_pd(
                                                       _mm256_add_pd(_mm256_mul_pd(
                                                               _mm256_sub_pd(_mm256_loadu_pd(tmpCur + 1), cur),
                                                               _mm256_add_pd(_mm256_loadu_pd(tmpP - Nx),
                                                                             _mm256_loadu_pd(tmpP))),
                                                                     _mm256_mul_pd(
                                                                             _mm256_sub_pd(_mm256_loadu_pd(tmpCur - 1),
                                                                                           cur),
                                                                             _mm256_add_pd(
                                                                                     _mm256_loadu_pd(tmpP - Nx - 1),
                                                                                     _mm256_loadu_pd(tmpP - 1)))),
                                                       _mm256_set1_pd(h2x2t2),
                                                       _mm256_mul_pd(
                                                               _mm256_add_pd(
                                                                       _mm256_mul_pd(_mm256_sub_pd(
                                                                               _mm256_loadu_pd(tmpCur + Nx), cur),
                                                                                     _mm256_add_pd(
                                                                                             _mm256_loadu_pd(tmpP - 1),
                                                                                             _mm256_loadu_pd(tmpP))),
                                                                       _mm256_mul_pd(_mm256_sub_pd(
